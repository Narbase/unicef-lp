package sd.gov.moe.lp.data.access.studentgradedassessments
...
import sd.gov.moe.lp.data.tables.StudentGradedAssessmentsTable
...
data class StudentGradedAssessment(
...
object StudentGradedAssessmentsDao:
	BasicDao<StudentGradedAssessmentsTable, UUID, StudentGradedAssessment>(StudentGradedAssessmentsTable) {
	override fun toStatement(model: StudentGradedAssessment, row: UpdateBuilder<Int>) {
		...
		row[table.attempts] = model.attempts
	}

	override fun toModel(row: ResultRow): StudentGradedAssessment {
