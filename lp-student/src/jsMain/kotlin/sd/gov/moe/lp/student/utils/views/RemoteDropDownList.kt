package sd.gov.moe.lp.student.utils.views
...
import sd.gov.moe.lp.student.network.*
...
import sd.gov.moe.lp.student.utils.PopupZIndex
...
import sd.gov.moe.lp.student.utils.views.theme.adminTheme
        ...
        if (isMock) {
            ...
            getItemsJob = networkCall(
                ...
                when {
                    ...
                    responseDto.status == INVALID_REQUEST -> loadingListState.value = BasicUiState.Loaded
